...
public class
    ...
    TextView firstName, lastName,userName,email, password;
    Button register;
    ImageView profile;
    String fName, lName,uName, mEmail, mPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userName = (TextView)findViewById(R.id.last_name);
    ...
    private File loadImageFromStorage(String imageName) {
        ...
        if (file.exists()) {
            ...
            file = null;
            profile.setImageResource(R.drawable.ic_reg_camera);
        }
        return file;
    }
